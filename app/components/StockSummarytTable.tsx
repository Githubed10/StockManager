...
const StockSummarytTable = ({ email }: { email: string }) => {
  ...
  return (
     <div className='w-full'>
        ...
        <div className='border-2 border-base-200 w-full p-4 rounded-3xl mt-4'>
             <h2 className='text-xl font-bold mb-4'>Articles en rupture</h2>
  ...
  <table className='table'>
             ...
             <EmptyState
              message='Aucun article en rupture'
...
export default StockSummarytTable