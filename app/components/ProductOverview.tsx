           ...
           <div className="grid grid-cols-2 gap-4">
                ...
                <div className="border-2 p-4 border-base-200 rounded-3xl">
                  <p className="stat-title">Articles en stock</p>
                    <div className="flex justify-between items-center">
                            ...
                            <div className="bg-success/25 p-3 rounded-full">
                              <Box className="w-5 h-5 text-success text-3xl"/>
                            </div>
                    </div>
               </div>
               ...
               <div className="border-2 p-4 border-base-200 rounded-3xl">
                  <p className="stat-title">Valeur du Stock</p>
                    <div className="flex justify-between items-center">
                            <div className="stat-value">{formatNumber(stats.stockValue)} XOF </div>
                            <div className="bg-success/25 p-3 rounded-full">
                              <DollarSign className="w-5 h-5 text-success text-3xl"/>
                            </div>
                    </div>
               </div>
               ...
               <div className="border-2 p-4 border-base-200 rounded-3xl">
                  <p className="stat-title">Nombre de catégories</p>
                    <div className="flex justify-between items-center">
                            ...
                            <div className="bg-success/25 p-3 rounded-full">
                              <Tag className="w-5 h-5 text-success text-3xl"/>
                            </div>
                    </div>
               </div>
               ...
               <div className="border-2 p-4 border-base-200 rounded-3xl">
                  <p className="stat-title">Total des transactions</p>
                    <div className="flex justify-between items-center">
                            ...
                            <div className="bg-success/25 p-3 rounded-full">
                              <ShoppingCart className="w-5 h-5 text-success text-3xl"/>
                            </div>
                    </div>
               </div>
