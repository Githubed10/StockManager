      ...
      const fetchProducts = async () => {
          ...
          const handleSubmit = async (e : React.FormEvent) => {
            ...
            if(!selectedProductId || quantity <= 0 ) {
                toast.error("Veuillez sélectionner un article et enter une quantité valide.")
                return
            }
            try {
                if(email){
...
<dialog id="my_modal_stock" className="modal">
  <div className="modal-box">
    ...
    <p className="py-4">Ajouter des quantités aux articles disponibles dans votre stock.</p>
